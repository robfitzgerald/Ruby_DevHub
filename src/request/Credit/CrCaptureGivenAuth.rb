...
class CrCaptureGivenAuth < Request
	attr_accessor :credentials
	attr_accessor :application
	attr_accessor :reports
	attr_accessor :transaction
	attr_accessor :fraudResult
    ...
    def to_json()
		...
		hash[:FraudResult] = (fraudResult.respond_to?(:to_hash) ? fraudResult.to_hash : fraudResult) if @fraudResult
